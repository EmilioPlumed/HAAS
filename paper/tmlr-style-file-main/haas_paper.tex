...
autonomously discovering improvements to an already-optimised neural network
...
reports an agent that autonomously optimises a neural network training codebase
...
\haas{} operationalises exactly this property, adding an explicit commitment
